...
echo -e
    echo -e $bk "×××××××××××××××××××××××××"
    echo -e $yl "Author : Mr.T1T4N"
    echo -e $yl "Team : MBT | LCT | ITL"
    echo -e $yl "YT : T1T4N TZY"
    echo -e $yl "Dear : Lu Yang Master Ajarin Newbie"
    echo -e $bk "××××××××××××××××××××××××××"
echo -e
echo -e
   echo -e $bk "∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆"
   echo -e $gl "1]. Hack Kontak"
   echo -e $gl "2]. Keluar"
   echo -e $bk "∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆"
    echo -e $gn "Pilih Memek"
        read -p "=>" lp
if [[ $lp == 1 || $lp == 1 ]]
then
clear
...
clear
sleep 6
echo -e $gl "SUCCESFULLY, SEDANG MENYIAPKAN TARGET"
sleep 2
echo -e $we "EITSSS..."
sleep 2
...
pip install bs4
sleep 2
echo -e $rd "Sipp, Sepertinya Sudah Di Install"
echo -e $we "Sedang Menunju, Ke Target"
clear
echo -e $rd "██╗  ██╗ █████╗  ██████╗██╗  ██╗"
echo -e $rd "██║  ██║██╔══██╗██╔════╝██║ ██╔╝"
echo -e $rd "███████║███████║██║     █████╔╝ "
...
echo -e
echo -e $bk "∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆"
echo -e $gl "1]. Cowo Orang"
echo -e $gl "2]. Cewe Orang"
echo -e $bk "∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆"
...
then
clear
xdg-open "https://wa.me/+6283895061531?text=Halo%2C%20Mau%20Kenalan"
exit
fi
if [[ $lok == 5 || $lok == 5 ]]
then
clear
xdg-open "https://wa.me/+62895334048676?text=Halo%2C%20Mau%20Kenalan"
exit
fi
# Kang Recode Sialan
# Kang Recode Sialan
